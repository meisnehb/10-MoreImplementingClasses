...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.startNew = Point(self.start.x + other_line.start.x, self.start.y + other_line.start.y)
        self.endNew = Point(self.end.x + other_line.end.x, self.end.y + other_line.end.y)

        return Line(self.startNew, self.endNew)
